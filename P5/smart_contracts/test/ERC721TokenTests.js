...
contract('ERC721 Interface', accounts => { 
    ...
    //mint() - tested by using createStar()
    //ownerOf()
    describe('can create a token', () => { 
        ...
        beforeEach(async function () {
            tx = await this.contract.createStar('awesome star!', '123', '456', '789', 'Too long to tell', tokenId, {from: user1})
        })
    ...
    describe('can transfer token', () => { 
        ...
        beforeEach(async function () { 
            await this.contract.createStar('awesome star!', '123', '456', '789', 'Too long to tell', tokenId, {from: user1})
    ...
    //safeTransferFrom()
    describe('can grant approval to transfer, and transfer using safeTransfer', () => { 
        let tokenId = 1
        let tx 
